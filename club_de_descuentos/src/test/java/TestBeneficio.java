...
public class TestBeneficio {
    ...
    public void crearBeneficioYObtenerClienteCorrecto() {
        ...
        Cliente clienteLeandro = new Cliente("Leandro", "baldileandro@gmail.com", TarjetaBeneficio.CLASSIC);
    ...
    public void crearBeneficioYObtenerClienteIncorrecto() {
        ...
        Producto producto = new Producto("Prueba", 100.0);
        Cliente clienteLeandro = new Cliente("Leandro", "baldileandro@gmail.com", TarjetaBeneficio.CLASSIC);
        Cliente clienteAnonimo = new Cliente("Anonimo", "anonimo@gmail.com", TarjetaBeneficio.CLASSIC);
